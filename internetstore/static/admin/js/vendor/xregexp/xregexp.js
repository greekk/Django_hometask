...
/**
 * Adds support for the `\p{L}` or `\p{Letter}` Unicode categories. Addon packages for other Unicode
...
/* Adds data for the Unicode `Letter` categories. Addon packages include other categories, scripts,
